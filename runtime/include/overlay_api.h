...
/* 11: ABI v23 screen-bound and mod-entry forwarders; use a fresh cache path
 *     so packaged pairs cannot be hidden by an older user cache on first boot. */
#define PSX_OVERLAY_CODEGEN_VER 11
